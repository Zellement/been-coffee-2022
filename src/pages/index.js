  ...
  return (
    <>
      <Seo
        ...
        description="Been Coffee is an independent, family-run coffee shop with amazing coffee, tea, bubble tea, boba tea, cakes, bagels, cobs & paninis near Derby & Willington, UK"
      />
